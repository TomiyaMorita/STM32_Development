...
C_SRCS += \
../ic/TMC7300/TMC7300.c 

OBJS += \
./ic/TMC7300/TMC7300.o 

C_DEPS += \
./ic/TMC7300/TMC7300.d 


# Each subdirectory must supply rules for building sources it contributes
ic/TMC7300/%.o ic/TMC7300/%.su: ../ic/TMC7300/%.c ic/TMC7300/subdir.mk
...
clean: clean-ic-2f-TMC7300

clean-ic-2f-TMC7300:
	-$(RM) ./ic/TMC7300/TMC7300.d ./ic/TMC7300/TMC7300.o ./ic/TMC7300/TMC7300.su

.PHONY: clean-ic-2f-TMC7300
