...
C_SRCS += \
../ic/TMC4671/TMC4671.c 

OBJS += \
./ic/TMC4671/TMC4671.o 

C_DEPS += \
./ic/TMC4671/TMC4671.d 


# Each subdirectory must supply rules for building sources it contributes
ic/TMC4671/%.o ic/TMC4671/%.su: ../ic/TMC4671/%.c ic/TMC4671/subdir.mk
...
clean: clean-ic-2f-TMC4671

clean-ic-2f-TMC4671:
	-$(RM) ./ic/TMC4671/TMC4671.d ./ic/TMC4671/TMC4671.o ./ic/TMC4671/TMC4671.su

.PHONY: clean-ic-2f-TMC4671
