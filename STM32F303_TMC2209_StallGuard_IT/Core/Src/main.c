...
//	SGTHRS_value = tmc2209_readInt(&TMC2209, TMC2209_SGTHRS);
//
////	tmc2209_readWriteArray(uint8_t channel, uint8_t *data, size_t writeLength, size_t readLength);
////	uint8_t txdata[8] = { 0 };
////	uint8_t rxdata[8] = { 0 };
////
////	txdata[0] = 0x05;
////	txdata[1] = 0xFF;
////	txdata[2] = 0x04;
////	txdata[3] = tmc2209_CRC8(txdata, 3);
////
////	HAL_UART_Transmit_IT(&huart1,&txdata[8],sizeof(txdata[8]));
////	HAL_UART_Receive_IT(&huart1,&rxdata[8], sizeof(rxdata[8]));
//	printf("rxdatais%ld\r\n",SGTHRS_value);
//}
